...
def main():
    ...
    """
    parser = argparse.ArgumentParser(description="Generate comments for LinkedIn posts in Richard's style")
    ...
    parser.add_argument("--data-json", type=str, default="Richard Persona.json", 
